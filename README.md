...
Бот анализирует сообщения в каналах и устанавливает статус `:zzz:` (или можно предварительно добавить кастомный ![image](https://github.com/user-attachments/assets/51e59f2b-be65-48c0-bcc4-cc38db455632))
